...
var PDF = (function () {
    ...
    PDF.prototype.bufferChecksum = function (buffer) {
        return crypto_1.createHash("sha256").update(buffer).digest("hex");
    };
    PDF.prototype.bufferToBase64 = function (buffer) {
    ...
    PDF.prototype.fromURL = function (url) {
        return __awaiter(this, void 0, void 0, function () {
