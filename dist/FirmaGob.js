...
var FirmaGob = (function () {
    ...
    FirmaGob.prototype.setConfig = function (props) {
        ...
        this.environment = (props === null || props === void 0 ? void 0 : props.environment) || Environment.TEST;
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!this.run) {
                            throw new Error("El run no puede estar vacío utiliza setRun para modificarlo");
                        }
                        ...
                        if (this.run === "22222222") {
                            console.warn("Estás utilizando el run de pruebas, para modificarlo utiliza setRun");
                        }
